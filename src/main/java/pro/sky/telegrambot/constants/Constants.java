...
public class Constants {
     ...
     */
    public static final String TEXTFOROMISSIONS = "Для оформления пропуска необходимо:\n" +
     ...
     */
    public static final String SAFETYRULESONTHETERRITORY = "*Этот приют содержит много собак и кошек разных возрастов и пород. \n" +
    ...
    public final static String WORKSCHEDULE = "Расписание:\n" +
    ...
    /**
     * Cписок причин, почему могут отказать и не дать забрать питомца из приюта.
     */
     ...
     * Вызов волонтера
     */
    public static final String CALL_VOLUNTEER = "К сожалению, я не могу помочь Вам в решении вопроса. Направляю к вам волонтера.";


    /**
     * Пример заполнения отчетов
     */
    public static final String REPORT_HElP =
            "\"Пришлите фотографию питомца, и заполните отчет по примеру \n " +
